let predeployed = {
                ...
                divText : '<div class="col-md-24">'+
                            '<div class="portlet light bordered">'+
                                '<div class="portlet-title">'+
                                    ...
                                    '</div>'+
                                    '<div class="actions">'+
                                        '<div class="btn-group" data-getcoord="15 predeployed-eksportBtn f,bb">'+
                                                    ...
                                                    '<div class="row">'+
                                                            ...
                                                            '<div class="form-group">'+
                                                                ...
                                                                '<div class="col-md-8">'+
                                                                    '<select name="filter_list_company" class="form-control form-filter select2me select2-hidden-accessible" tabindex="-1" aria-hidden="true">'+
                                                                        ...
                                                                        '<option value="9001" selected="selected">Asuransi 1</option>'+
                                                                        '<option value="9002" selected="selected">Asuransi 2</option>'+
                                                                        '<option value="9003" selected="selected">Asuransi 3</option>'+
                                                                    '</select>'+
                                                                    '<span class="select2 select2-container select2-container--bootstrap" data-getcoord="0 predeployed-selectAsuransi f,bb,m,h,k*10" dir="ltr" style="width: auto;">'+
                                                                        '<span class="selection">'+
                                                                            '<span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-filter_list_company-3g-container">'+
                                                                                '<span class="select2-selection__rendered" id="select2-filter_list_company-3g-container" title="--All Asuransi--">'+
                                                                                    '<span class="select2-selection__clear">×</span>"--All Asuransi--"'+
                                                                                '</span>'+
                                                            ...
                                                            '<div class="form-group">'+
                                                                ...
                                                                '<div class="col-md-8">'+
                                                                    '<select name="filter_list_workshop" class="form-control form-filter select2me select2-hidden-accessible" tabindex="-1" aria-hidden="true">'+
                                                                        ...
                                                                        '<option value="1385">Workshop 1</option>'+
                                                                        '<option value="1386">Workshop 2</option>'+
                                                                        '<option value="1387">Workshop 3</option>'+
                                                                    '</select>'+
                                                                    '<span class="select2 select2-container select2-container--bootstrap" data-getcoord="1 predeployed-inputWorkshop f,bb,m,h,k*10" dir="ltr" style="width: auto;">'+
                                                                        '<span class="selection">'+
                                                        ...
                                                        '<div class="col-md-10">'+
                                                            '<div class="form-group">'+
                                                                ...
                                                                '<div class="col-md-8">'+
                                                                    '<div class="input-icon right" data-getcoord="2 predeployed-inputTicketNo f,bb,m,h,k">'+
                                                                        '<i class="fa"></i>'+
                                                        ...
                                                        '<div class="col-md-10">'+
                                                            '<div class="form-group">'+
                                                                ...
                                                                '<div class="col-md-8">'+
                                                                    '<div class="input-icon right" data-getcoord="3 predeployed-inputReporterName f,bb,m,h,k">'+
                                                                        '<i class="fa"></i>'+
                                                        ...
                                                        '<div class="col-md-10">'+
                                                            '<div class="form-group">'+
                                                                ...
                                                                '<div class="col-md-8">'+
                                                                    '<div class="input-icon right" data-getcoord="4 predeployed-inputCarPoliceNo f,bb,m,h,k">'+
                                                                        '<i class="fa"></i>'+
                                                        ...
                                                        '<div class="col-md-10">'+
                                                            '<div class="form-group">'+
                                                                ...
                                                                '<div class="col-md-8">'+
                                                                    ...
                                                                    '</select>'+
                                                                    '<span class="select2 select2-container select2-container--bootstrap" data-getcoord="5 predeployed-inputStatusDate f,bb,m,h,k*8" dir="ltr" style="width: auto;">'+
                                                                        '<span class="selection">'+
    ...
    elem2 : {
        ...
        designList : {
            0 : {
                divText : '<div class="col-md-12" style="padding-bottom: 50px;">'+
